...
static void UserApp1SM_Idle(void) {
  ...
  if (WasButtonPressed(BUTTON0)) {
    ...
    u8 u8Cmd = LCD_DISPLAY_CMD | LCD_DISPLAY_ON;
    if (bCurserOn) {
      u8Cmd |= LCD_DISPLAY_CURSOR | LCD_DISPLAY_BLINK;
    }
