...
*/
void UserApp3RunActiveState(void) { UserApp3_pfStateMachine(); } /* end UserApp3RunActiveState */
...
static void UserApp3SM_Idle(void) {} /* end UserApp3SM_Idle() */

/*-------------------------------------------------------------------------------------------------------------------*/
/* Handle an error */
static void UserApp3SM_Error(void) {} /* end UserApp3SM_Error() */
