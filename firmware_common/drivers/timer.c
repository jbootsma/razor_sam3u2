...
*/
void TimerRunActiveState(void) { Timer_fpStateMachine(); } /* end TimerRunActiveState */
...
*/
static void TimerDefaultCallback(void) {} /* end TimerDefaultCallback() */
...
*/
static void TimerSM_Idle(void) {} /* end TimerSM_Idle() */

/*-------------------------------------------------------------------------------------------------------------------*/
/* Handle an error */
static void TimerSM_Error(void) {} /* end TimerSM_Error() */
